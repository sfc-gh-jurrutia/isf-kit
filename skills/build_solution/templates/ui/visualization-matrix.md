...
> Intelligent mapping from solution inputs to visualization recommendations.
> Used by `001_plan/SKILL.md` Step 5.5 to generate UI strategy.
...
- [ ] Solution needs to prove "real Snowflake data"
...
- [ ] Solution will show loading states intentionally
...
**Best for:** Executive persona, quarterly reviews, KPI-focused solutions
...
**Best for:** Cortex Analyst/Agent solutions, conversational BI, analyst persona
...
**Best for:** Data analyst persona, SQL exploration, technical solutions
