---
name: snowflake-solution-package
description: "Create solution packages (presentation pages, SVG diagrams, blogs, slides, video scripts). Triggers: solution package, presentation materials, executive deck, architecture diagram, generate SVGs."
---

# Solution Presentation Packages
...
**Integrate with `snowflake-demo-reflection-persona` skill** for tone and content alignment.
...
See bundled references for each step:
- [presentation-page.md](references/presentation-page.md)
- [architecture-diagram.md](references/architecture-diagram.md)
- [blog.md](references/blog.md)
- [linkedin-blurb.md](references/linkedin-blurb.md)
- [slides.md](references/slides.md)
- [video.md](references/video.md)
