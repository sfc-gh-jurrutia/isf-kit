---
name: specify-generate-llm
description: "Generate synthetic data using Cortex COMPLETE. Use for: creative realistic data, LLM-powered generation, varied demo data. Triggers: llm data, cortex generate, ai data generation"
parent_skill: specify-generate
---

# LLM-Powered Data Generation

> Generate realistic, varied demo data using Snowflake Cortex COMPLETE

## When to Load

From `generate/SKILL.md` Step 3 when user selects "LLM-Powered" mode.
